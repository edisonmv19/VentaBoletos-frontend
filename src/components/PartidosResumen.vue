<template>
    ...
    <p></p>
      ...
      <!-- Contenido principal -->
      <div class="content">
        <h1 style="color: aliceblue;">Seleccionar Partido Para Resumen Extendido</h1>
        ...
        <div class="card-container" style="align-items: center;">
          <div class="card" style="align-items: center;" v-for="partido in partidos" :key="partido.CODIGO">
            ...
            <button class="card-button" @click="comprarEntradas(partido.CODIGO)">Resumen</button>
          </div>
        </div>
      </div>
    </div>
    ...
    export default {
      ...
      methods: {
        ...
        comprarEntradas(codigoPartido) {
          ...
          this.$router.push(`/resumen-partidos/${codigoPartido}`);
        }
      }
